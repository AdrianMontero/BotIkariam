...
public class JPEdificios extends javax.swing.JPanel {
    ...
    public JPEdificios() throws InterruptedException {
        ...
        try { //Cargamos las ciudades que tiene el usuario
            ...
            JOptionPane.showMessageDialog(null, "Error al intentar recoger las ciudades", "Informacion", JOptionPane.INFORMATION_MESSAGE);
        }
    }

    /**
     * Metodo usado para actualizar la table con todos los edificios,
    ...
    public void actualizarTablaTodos() throws SQLException {
        ...
        misEdificios = miBot.getTolosLosEdificios(); //Obtenemos todos los edificios de la BD
    ...
    /**
     * Metodo usado para actualizar la table con todos los edificios que hay
     * para subir en una ciudad
     *
     * @param nCiudad Numero de la ciudad de la cual queremos obtener los
     * edificios
     * @throws SQLException Error al conectar con la BD
     */
    ...
    private void jcbCiudadPEdifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbCiudadPEdifActionPerformed
        ...
        try { //Añadimos el edificio a la tabla
